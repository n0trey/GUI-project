...
root = Tk()
root.title ('Bismillah yok bisa yokkkk')
...
def length():
    topL = Toplevel()
    topL.title('Length Etention')
    topL.geometry('500x500+10+10')
    topL.config(bg = '#243447')

    lbl1=Label(topL, text='Length Expansion', font = ('Arial', 12), bg = '#243447', fg = 'white',)
...
#calculate button
    ...
    def result():
        ...
        ltotal = Label(topL, text = str(Ltotal) + ' m', font = ('Arial', 12)).place(x = 255, y = 400)
        ΔL = Label(topL, text = str(L) + ' m', font = ('Arial', 12)).place(x = 255, y = 350)
    ...
    lbl7=Label(topL, text = 'Total Area Expansion', font = ('Arial', 12), bg = '#243447', fg = 'white').place(x = 100, y = 400)
...
#graph
    ...
    def graph():
        ...
        fig.get_tk_widget().pack(side=tk.RIGHT, fill=tk.BOTH, expand=0)
        sb1.set_xlabel ('L0ΔT')
        sb1.set_ylabel ('Thermal Expansion ΔL')
        sb1.set_title ('Thermal Expansion Graphic')
...
def area():
    ...
    topA.geometry('500x500+10+10')
    topA.config(bg = '#243447')

    lbl1=Label(topA, text='Area Expansion', font = ('Arial', 12), bg = '#243447', fg = 'white',)
    lbl1.place(x=160, y=50)
    ...
    lbl3=Label(topA, text='Original Length', font = ('Arial', 12), bg = '#243447', fg = 'white')
    lbl3.place(x=100, y=150)
...
#calculate button
    ...
    def result():
        ...
        L = float(X0.get())*(1+float(A))
        Ltotal = float(L)+float(X0.get())
        ltotal = Label(topA, text = str(Ltotal) + ' m²', font = ('Arial', 12)).place(x = 255, y = 400)
        ΔL = Label(topA, text = str(L) + ' m²', font = ('Arial', 12)).place(x = 250, y = 350)
...
def vol():
    ...
    topV.geometry('500x500+10+10')
    topV.config(bg = '#243447')

    lbl1=Label(topV, text='Area Expansion', font = ('Arial', 12), bg = '#243447', fg = 'white',)
    lbl1.place(x=160, y=50)
    ...
    lbl3=Label(topV, text='Original Length', font = ('Arial', 12), bg = '#243447', fg = 'white')
    lbl3.place(x=100, y=150)
...
#calculate button
    ...
    def result():
        ...
        L = float(X0.get())*(1+float(A))
        Ltotal = float(L)+float(X0.get())
        ltotal = Label(topV, text = str(Ltotal) + ' m³', font = ('Arial', 12)).place(x = 255, y = 400)
        ΔL = Label(topV, text = str(L) + ' m³', font = ('Arial', 12)).place(x = 250, y = 350)
    ...
    lbl7=Label(topV, text = 'Total Area Expansion', font = ('Arial', 12), bg = '#243447', fg = 'white').place(x = 100, y = 400)
